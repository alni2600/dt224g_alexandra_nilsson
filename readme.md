...
2. _Varför använder man branches istället för att jobba direkt i main?_  
   ...
   * I stora projekt kan man ha feature branches för tydligare struktur.
...
4. _Vad är skillnaden mellan att pusha till GitHub och att publicera direkt på t.ex. Netlify?_  
  Om du pushar mot Github uppdateras projektet automatiskt. Om du bara publicerar direkt på t.ex. Netlify har du dels inte kod-historiken och dels måste du varje gång du vill ändra och uppdatera projektet ladda upp filen på nytt i Netlify. 
5. _Om du vill exkludera någon fil i projektet från versionshanteringen, hur gör du då?_  
  Då döper man filen så att den har ändelsen .gitignore och i den skriver du vad du vill exkludera.