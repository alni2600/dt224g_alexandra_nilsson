...
Github: [https://alni2600.github.io/dt224g_alexandra_nilsson/](https://alni2600.github.io/dt224g_alexandra_nilsson/)  
Netlify: [https://dt224g-alexandra-nilsson.netlify.app/](https://dt224g-alexandra-nilsson.netlify.app/)
...
2. _Varför använder man branches istället för att jobba direkt i main?_  
  ...
  * I stora projekt kan man ha feature brands för tydligare struktur.
...
4. _Vad är skillnaden mellan att pusha till GitHub och att publicera direkt på t.ex. Netlify?_  
  Man kan koppla Netlity och andra tjänster så att de publicerar/uppdaterar automatiskt varje gång man pushar ex. sin main till Github. Om du bara publicerar direkt på Netlify får du inte med historiken i källkoden. Dessutom måste du, varje gång du har gjort ändringar och vill uppdatera projektet, göra ändringarna på din dator och sedan ladda upp filen på nytt till Netlify.
5. _Om du vill exkludera någon fil i projektet från versionshanteringen, hur gör du då?_  
  Då skapar man en fil i projektet som har ändelsen .gitignore och lägger till de filer man inte vill ska laddas upp. 
